...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	...
    	// Implement logic based on the policy rules
        if (writtenByYourself) {
            return true;
        }
        if (writtenAsCourseWork && citingYourSource && implementationRequired) {
            return true;
        }
        if (!writtenByYourself && !citingYourSource) {
            return false;
        }
        return false;
    ...
    public static void main(String[] args) {
        System.out.println("You may certainly use code you wrote yourself yes i have wrriten code by myself: " +
